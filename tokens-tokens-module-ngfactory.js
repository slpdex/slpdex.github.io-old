...
/* harmony import */ var _endpoints_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../endpoints.service */ "./src/app/endpoints.service.ts");
        ...
        this.getTokenDetails = function () {
            _this.endpointsService
                ...
                if (data.c && data.c.length) {
                    ...
                    _this.timeSinceLastTrade = moment__WEBPACK_IMPORTED_MODULE_1__["unix"](_this.tokenDetails.lastTrade.timestamp)
                        .fromNow();
                }
                else {
